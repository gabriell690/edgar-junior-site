          ...
          <div className="ticker flex gap-5">
            {ticker.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="min-w-62.5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 transition-all duration-300 hover:border-yellow-400/40 hover:bg-white/10 hover:-translate-y-1"
                >
